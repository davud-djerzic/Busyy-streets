...
public class Shop : MonoBehaviour
{
    ...
    public void onShopItemBtnClicked(int itemIndex)
    {
        if (Game.instance.hasEnough(ShopItemList.shopItemList[itemIndex].price)) // provjerava da li posjedujemo dovoljno coinsa da kupimo auto
        {
            ...
            if (PlayerPrefs.GetInt("numberOfBoughtCar", 0) >= 6 && PlayerPrefs.GetInt("finishedActionShop3", 0) == 0)  // ako smo kupili vise od 5 auta
            {
            ...
            else if (PlayerPrefs.GetInt("numberOfBoughtCar", 0) >= 3 && PlayerPrefs.GetInt("numberOfBoughtCar", 0) <= 5) // ako smo kupili manje od 5 auta
            {
                PlayerPrefs.SetFloat("percentageOfBoughtCar", (PlayerPrefs.GetInt("numberOfBoughtCar", 0) - 3) / 3.0f); //  broji broj kupljenih auta sa 5 da bi dobili percentage koji se prosledjuju u drugu skriptu
            }
            if (PlayerPrefs.GetInt("numberOfBoughtCar", 0) >= 11 && PlayerPrefs.GetInt("finishedActionShop4", 0) == 0)  // ako smo kupili vise od 5 auta
            {
            ...
            else if (PlayerPrefs.GetInt("numberOfBoughtCar", 0) >= 7 && PlayerPrefs.GetInt("numberOfBoughtCar", 0) <= 10) // ako smo kupili manje od 5 auta
            {
                PlayerPrefs.SetFloat("percentageOfBoughtCar", (PlayerPrefs.GetInt("numberOfBoughtCar", 0) - 6) / 5.0f); //  broji broj kupljenih auta sa 5 da bi dobili percentage koji se prosledjuju u drugu skriptu
            }

            if (PlayerPrefs.GetInt("numberOfBoughtCar", 0) >= 11 && PlayerPrefs.GetInt("numberOfBoughtCar", 0) <= 17 && PlayerPrefs.GetInt("finishedActionShop5", 0) == 0) // ako smo kupili manje od 5 auta
            {
                PlayerPrefs.SetFloat("percentageOfBoughtCar", (PlayerPrefs.GetInt("numberOfBoughtCar", 0) - 11) / 7.0f); //  broji broj kupljenih auta sa 5 da bi dobili percentage koji se prosledjuju u drugu skriptu
            }
            if (PlayerPrefs.GetInt("numberOfBoughtCar", 0) >= 18 && PlayerPrefs.GetInt("finishedActionShop5", 0) == 0)
            {
                AchievementAnimation.earnedCoins1 = 1000;
                PlayerPrefs.SetInt("Coins", PlayerPrefs.GetInt("Coins", 0) + 1000);
                PlayerPrefs.SetFloat("percentageOfBoughtCar", 1f);
